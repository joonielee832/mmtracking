...
#? Experiment details
exp_dir = "prob_reid_mot17_train_exp36"
num_gpus = 2
...
model = dict(
    reid=dict(
        ...
        head=dict(
            ...
            out_channels=128,
            num_classes=380,
            num_samples=1000,         #* num samples for cross entropy; configurable
            ...
            loss_uncertainty=dict(
                type='FeatureUncertaintyLoss', margin_exp=1, loss_weight=1.0),    #* margin_exp and loss_weight configurable
