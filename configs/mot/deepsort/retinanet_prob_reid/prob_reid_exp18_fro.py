...
model = dict(
    ...
    reid=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=  # noqa: E251
                '/home/results/prob_reid_mot17_train_exp18/latest.pth'  # noqa: E501
        )),
    tracker=dict(
        type='SortTracker',
        obj_score_thr=0.5,
        reid=dict(
            ...
            img_scale=(256, 128),
            img_norm_cfg=None,
            match_score_thr=4.0,    #* originally 2.0; double if 'Frobenius'
            prob=dict(mode='Frobenius', num_samples=100)),  #* mode ('Jensen', 'Frobenius'); if 'Jensen', set num_samples
        match_iou_thr=0.5,
        momentums=None,
        num_tentatives=2,
