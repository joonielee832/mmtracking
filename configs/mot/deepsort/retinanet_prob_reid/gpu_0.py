...
model = dict(
    ...
    detector=dict(
        ...
        init_cfg=dict(
            ...
            '/home/results/retinanet_mot17det_train_exp9/best_bbox_mAP_epoch_4.pth'   #* configurable
    ...
    tracker=dict(
        ...
        reid=dict(
            ...
            img_scale=(256, 128),
            img_norm_cfg=None,
            match_score_thr=100,    #* originally 2.0 (classic); double if 'Frobenius'; configurable
            prob=False),  #* mode ('Jensen', 'Frobenius', 'KL'); if 'Jensen', set num_samples
        match_iou_thr=0.5,
        momentums=None,
        num_tentatives=2,
        alpha=0.0,
